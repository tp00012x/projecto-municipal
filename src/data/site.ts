...
export const councilMembers = [
  ...
  },
  {
    ...
    position: "Regidor",
    number: 8,
    src: "/team/regidor-8-leonardo-alcedo-v2.png",
    alt: "Leonardo Sebastián Alcedo Ego Aguirre, regidor #8",
    objectPosition: "50% 22%",
    imageScale: 1,
  ...
  {
    id: 10,
    name: "Daniel Pérez Salguero",
    position: "Regidor",
    number: 10,
    src: "/team/regidor-10-daniel-perez-salguero.png",
    alt: "Daniel Pérez Salguero - Regidor #10",
    objectPosition: "50% 18%",
    imageScale: 1,
    bio: "Daniel es docente, gestor cultural y vecino de la cuadra 9 de Cipriano Dulanto. Durante los últimos 4 años he venido apoyando de diversas formas al Comité Vecinal de mi sector especialmente fiscalizando e informando sobre la problemática de los vecinos. Actualmente, deseo ser regidor del distrito para asegurarme que los impuestos de todos nosotros sean usados de manera apropiada y que las obligaciones de las autoridades se cumplan respetando los derechos de todos en Pueblo Libre.",
  },
  {
    id: 11,
